...
import { Wrench, CheckCircle2, Circle, ShieldCheck } from 'lucide-react';

export const TechnicianChecklist = ({ initialChecklist }) => {
    ...
    <div className="p-5 rounded-2xl bg-slate-900 border border-slate-800 backdrop-blur-xl shadow-xl space-y-4">
      <div className="flex items-center justify-between border-b border-slate-800 pb-3">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h3 className="text-sm font-bold text-slate-100">Technician Task Checklist</h3>
            <p className="text-[11px] text-slate-400">Required maintenance execution steps</p>
          </div>
        </div>

        <span className="px-2.5 py-1 rounded-full bg-cyan-500/15 text-cyan-300 font-mono text-[10px] font-bold border border-cyan-500/30">
