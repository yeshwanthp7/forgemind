...
const SDK_VERSION = '2.15.0'; // x-release-please-version
...
class ApiClient {
    ...
    async unaryApiCall(url, requestInit, httpMethod, retryOptions) {
        return this.apiCall(url.toString(), Object.assign(Object.assign({}, requestInit), { method: httpMethod }), retryOptions)
            .then(async (response) => {
    ...
    async apiCall(url, requestInit, retryOptions) {
        ...
        const retryableStatusCodes = (_a = retryOptions.httpStatusCodes) !== null && _a !== void 0 ? _a : DEFAULT_RETRY_HTTP_STATUS_CODES;
